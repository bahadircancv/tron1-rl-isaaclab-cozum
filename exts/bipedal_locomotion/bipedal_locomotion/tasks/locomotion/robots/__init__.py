...
from bipedal_locomotion.tasks.locomotion.agents.limx_rsl_rl_ppo_cfg import PF_TRON1AFlatPPORunnerCfg, WF_TRON1AFlatPPORunnerCfg, WF_TRON1ARoughPPORunnerCfg, SF_TRON1AFlatPPORunnerCfg
...
limx_wf_blind_rough_runner_cfg = WF_TRON1ARoughPPORunnerCfg()
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_cfg_entry_point": limx_pf_blind_flat_runner_cfg, #TODO implement rough_runner_cfg
    },
)
...
#############################
gym.register(
    id="Isaac-Limx-WF-Blind-Rough-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": limx_wheelfoot_env_cfg.WFBlindRoughEnvCfg,
        "rsl_rl_cfg_entry_point": limx_wf_blind_rough_runner_cfg,
    },
)

gym.register(
    id="Isaac-Limx-WF-Blind-Rough-Play-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": limx_wheelfoot_env_cfg.WFBlindRoughEnvCfg_PLAY,
        "rsl_rl_cfg_entry_point": limx_wf_blind_rough_runner_cfg,
    },
)
